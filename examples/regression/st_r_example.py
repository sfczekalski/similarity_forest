...
from sklearn.datasets import make_regression, load_svmlight_file, make_friedman1, load_wine
...
st = SimilarityTreeRegressor(sim_function=np.dot, max_depth=None, n_directions=1, sampling_strategy='random')
